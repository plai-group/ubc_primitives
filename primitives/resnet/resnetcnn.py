...
class ResNetCNN(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams], WeightsDirPrimitive):
    """
    RenNet is a standard Convolutional Neural Network primitive using
    ...
    Citation: https://arxiv.org/pdf/1512.03385.pdf
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        "keywords": ["cnn", "resnet", "convolutional neural network", "deep learning"],
