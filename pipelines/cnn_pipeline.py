...
def make_pipeline_1():
    ...
    step_3 = PrimitiveStep(primitive=ConvolutionalNeuralNetwork)
    ...
    step_3.add_hyperparameter(name='cnn_type',    argument_type=ArgumentType.VALUE, data='mobilenet')
    ...
    with open('./cnn_pipeline_1.json', 'w') as write_file:
...
def make_pipeline_2():
    ...
    with open('./cnn_pipeline_2.json', 'w') as write_file:
        write_file.write(pipeline.to_json(indent=4, sort_keys=False, ensure_ascii=False))
