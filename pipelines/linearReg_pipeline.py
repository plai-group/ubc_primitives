...
def make_pipeline():
    ...
    step_3.add_hyperparameter(name='minibatch_size',   argument_type=ArgumentType.VALUE, data=50)
    step_3.add_hyperparameter(name='num_iterations',   argument_type=ArgumentType.VALUE, data=100)
